...
class _PayoutScreenState extends ConsumerState<PayoutScreen> {
  ...
  Future<void> _openCoreRoute(String routeName) async {
    if (routeName == RouteNames.payout) {
      return;
    }
  ...
  Future<void> _openFilterSheet() async {
    final selected = ref.read(payoutStatusFilterProvider);
    final result = await showModalBottomSheet<PayoutStatus?>(
      context: context,
      showDragHandle: true,
        ...
        return SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                const ListTile(title: Text('Filter payouts by status')),
                ListTile(
                ...
                for (final status in <PayoutStatus>[
    ...
    ref.read(payoutStatusFilterProvider.notifier).state = result;
  }
  ...
  Widget build(BuildContext context) {
    ...
    final appBarActions = <Widget>[
      ...
      IconButton(
        ...
        onPressed: () {
          ref.read(payoutStatusFilterProvider.notifier).state = null;
          AppSnackbar.show(context, 'Showing full payout history.');
        },
    ...
    return CoreScaffold(
      currentRoute: RouteNames.payout,
      title: 'Payouts',
