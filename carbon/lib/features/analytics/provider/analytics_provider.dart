...
final analyticsAsyncProvider = FutureProvider<AnalyticsData>((ref) async {
  ...
  try {
    ...
    developer.log(error.toString(), name: 'AnalyticsProvider');
    ref.read(analyticsErrorProvider.notifier).state = error.message;
    return AnalyticsData.empty();
  } catch (error, stackTrace) {
    developer.log(
      'Unexpected analytics load error: $error',
      name: 'AnalyticsProvider',
      error: error,
      stackTrace: stackTrace,
    );
    ref.read(analyticsErrorProvider.notifier).state =
...
final analyticsDataProvider = Provider<AnalyticsData>((ref) {
  return ref
      ...
      .maybeWhen(data: (data) => data, orElse: AnalyticsData.empty);
});
...
class AnalyticsAction {
  ...
  Future<String?> buildExportReport() async {
    ...
    try {
      ...
      developer.log(
        'Unexpected analytics export error: $error',
        name: 'AnalyticsProvider',
        error: error,
        stackTrace: stackTrace,
      );
